...
TEST_SUITE("Board") {
    ...
    TEST_CASE("Board::doMove and Board::undoMove") {
        ...
        board.setStartpos();
        move::Move m        = move::Move(Piece::WHITE_PAWN, Square::E2, Square::E4, Piece::NO_PIECE,
        ...
        m        = move::Move(Piece::WHITE_KING, Square::E1, Square::G1, Piece::NO_PIECE,
        ...
        fen::parseFEN(&board, fen);
        m        = move::Move(Piece::BLACK_KING, Square::E8, Square::G8, Piece::NO_PIECE,
                              move::MoveFlag::MOVE_CASTLE_KING_SIDE);
        is_valid = board.doMove(m);
        CHECK(is_valid);
        ...
        fen::parseFEN(&board, fen);
        m        = move::Move(Piece::WHITE_KING, Square::E1, Square::C1, Piece::NO_PIECE,
        ...
        fen::parseFEN(&board, fen);
        m        = move::Move(Piece::BLACK_KING, Square::E8, Square::C8, Piece::NO_PIECE,
                              move::MoveFlag::MOVE_CASTLE_QUEEN_SIDE);
        is_valid = board.doMove(m);
        CHECK(is_valid);
        CHECK(board.getPiece(Square::E8) == Piece::NO_PIECE);
        ...
        fen::parseFEN(&board, fen);
        m        = move::Move(Piece::WHITE_PAWN, Square::D5, Square::E6, Piece::BLACK_PAWN,
        ...
        fen::parseFEN(&board, fen);
        m        = move::Move(Piece::BLACK_PAWN, Square::D4, Square::E3, Piece::WHITE_PAWN,
                              move::MoveFlag::MOVE_CAPTURE_EP);
        is_valid = board.doMove(m);
        CHECK(is_valid);
        ...
        // KNIGHT
        m        = move::Move(Piece::WHITE_PAWN, Square::A7, Square::A8, Piece::NO_PIECE,
        ...
        // KNIGHT
        m        = move::Move(Piece::WHITE_PAWN, Square::A7, Square::B8, Piece::BLACK_QUEEN,
